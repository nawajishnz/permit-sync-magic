...
import { FileCheck, Clock, Award, ArrowRight, Check, Globe, Search, FileText, CreditCard, Zap } from 'lucide-react';
...
const HowItWorks = () => {
  ...
  return <section className="relative py-20 overflow-hidden bg-gradient-to-b from-indigo-600 to-indigo-700">
      {/* Content container */}
      <div className="relative z-10 container mx-auto px-4">
        <div className="text-center mb-10">
          ...
          duration: 0.5
        }} className="text-3xl md:text-4xl font-bold text-white mb-4">Expert Application With Permitsy</motion.h2>
          <motion.p initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
        ...
        <div className="hidden md:block">
          <div className="grid grid-cols-4 gap-6 max-w-6xl mx-auto">
            {steps.map(step => <motion.div key={step.id} className={`bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 transition-all duration-300 ${activeStep === step.id ? 'ring-2 ring-white/50 transform -translate-y-2' : ''}`} onMouseEnter={() => {
            ...
            delay: step.id * 0.1
                ...
                <div className="relative">
                  <motion.div className={`w-16 h-16 bg-gradient-to-br ${step.color} rounded-2xl flex items-center justify-center mb-6 text-white shadow-lg mx-auto`} whileHover={{
                scale: 1.05
                ...
                repeatType: "reverse"
                  ...
                  {activeStep === step.id && <motion.div className="absolute -top-2 -right-2 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center" initial={{
                scale: 0
              }} animate={{
                scale: 1
              }} transition={{
                ...
                <div className="text-center">
                  ...
                  {hoveredStep === step.id && <motion.div initial={{
                opacity: 0,
                height: 0
              }} animate={{
                opacity: 1,
                ...
                height: 0
                      ...
                      <div className="space-y-2 mb-4">
                        {step.features.map((feature, idx) => <motion.div key={idx} className="flex items-center text-white/90" initial={{
                    opacity: 0,
                    x: -5
                  }} animate={{
                    opacity: 1,
                    ...
                    delay: idx * 0.2
                      ...
                      <Button variant="outline" size="sm" className="mt-2 bg-white/10 text-white border-white/30 hover:bg-white/20 w-full" asChild>
                        <Link to="/visa-finder">
                          Get Started
        ...
        <div className="md:hidden">
          <div className="space-y-4">
            {steps.map(step => <motion.div key={step.id} className="bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20" initial={{
            opacity: 0,
            x: -20
          }} whileInView={{
            opacity: 1,
                ...
                <div className="flex items-start">
                  <div className="mr-4 flex-shrink-0">
                    <div className="relative">
                      ...
                      <motion.div className={`w-14 h-14 bg-gradient-to-br ${step.color} rounded-xl flex items-center justify-center`} animate={activeStep === step.id ? {
                    scale: [1, 1.05, 1],
        ...
        delay: 0.5
          ...
          <Button size="lg" variant="default" className="bg-white text-indigo-700 hover:bg-white/90 shadow-xl" asChild>
            <Link to="/visa-finder">
